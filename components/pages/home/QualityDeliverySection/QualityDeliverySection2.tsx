    ...
    const observer = new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting) {
          setAnimationDuration(28);
          setTimeout(() => setAnimationDuration(0), 1000);
        } else {
  ...
  return (
    <div ref={containerRef} className="absolute inset-0 overflow-hidden pointer-events-none select-none">
      <div
        ...
        `}
        style={{
          animationDuration: animationDuration === 0 ? undefined : `${animationDuration}s`,
          animationPlayState: animationDuration === 0 ? "paused" : "running",
        }}
      >
