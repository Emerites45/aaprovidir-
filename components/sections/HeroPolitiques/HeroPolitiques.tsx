    ...
    <section className="bg-[linear-gradient(to_right,#006af1,#80e9f9)]">
      <div className="relative h-screen overflow-hidden">
        ...
        <svg viewBox="0 0 1000 340" className="w-full" preserveAspectRatio="xMidYMax meet">
          ...
          <path d="M 212.3,340 A 320,320 0 0 1 787.7,340 Z" fill="#f3fff8" />
        ...
        <img
          ...
          className="relative left-[-200px] bottom-[180px] z-20 mx-auto h-[120%] w-auto object-contain object-bottom"
        />
